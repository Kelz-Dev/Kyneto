                    ...
                    <div className="row mt-5">
                        <div className="col-lg-8 col-md-7">
                            <div className="section-title me-lg-5">
                                ...
                                <p className="text-muted">The listed author of the paper is Satoshi Nakamoto, a presumed pseudonym for a person or group who's true identity remains a mystery. Nakamoto released the first open-source Kyneto software client on January 9th, 2009, and anyone who installed the client could begin using Kyneto.</p>
                                <p className="text-muted">Initial growth of the Kyneto network was driven primarily by its utility as a novel method for transacting value in the digital world. Early proponents were, by and large, 'cypherpunks' - individuals who advocated the use of strong cryptography and privacy-enhancing technologies as a route to social and political change. However, speculation as to the future value of Kyneto soon became a significant driver of adoption.</p>
                                <p className="text-muted">The price of Kyneto and the number of Kyneto users rose in waves over the following decade. As regulators in major economies provided clarity on the legality of Kyneto and other cryptocurrencies, a large number of Kyneto exchanges established banking connections, making it easy to convert local currency to and from Kyneto. Other businesses established robust custodial services, making it easier for institutional investors to gain exposure to the asset as a growing number of high-profile investors signaled their interest.</p>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-4 col-md-5 mt-4 pt-2 mt-sm-0 pt-sm-0">
                            <div className="card p-4 text-center rounded shadow border-0 bg-white sticky-bar">
                                ...
                                <h6 className="text-muted mb-0 mt-3">Choose from Kyneto, Kyneto Cash, Ethereum, and more...</h6>
                            </div>
                        </div>
                    </div>
                </div>
