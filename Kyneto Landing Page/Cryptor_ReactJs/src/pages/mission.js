                ...
                <div className="row align-items-center">
                    <div className="col-lg-7 col-md-6 order-2 order-md-1">
                        <div className="section-title me-lg-5">
                            ...
                            <p className="text-muted">What's the secret to Kyneto's success? The answer is obvious: Our people. We are proud to have one of the most talented, hardworking and passionate teams the world has to offer. Interested in joining our team?</p>
                        
                            <ul className="list-unstyled text-muted mb-0">
                                <li className="mb-0 ms-0"><span className="text-primary h5 me-2"><MdOutlineCheckCircle className="align-middle"/></span><span className="fw-medium">Kyneto Wallet.</span>  Your Keys, Your Crypto.</li>
                                <li className="mb-0 ms-0"><span className="text-primary h5 me-2"><MdOutlineCheckCircle className="align-middle"/></span><span className="fw-medium">Kyneto Earn.</span>  No lock-up period and stable returns.</li>
                                <li className="mb-0 ms-0"><span className="text-primary h5 me-2"><MdOutlineCheckCircle className="align-middle"/></span><span className="fw-medium">Kyneto Swap.</span>  Swap Kyneto coins and earn Triple Yield.</li>
                            </ul>
                ...
                <div className="row align-items-center">
                    <div className="col-lg-7 col-md-6 order-1 order-md-2">
                        <div className="section-title ms-lg-5">
                            ...
                            <p className="text-muted mb-0">Kyneto has a strategic partnership with Ledger, integrating its institutional-grade custody solution, Ledger Vault. We also leverage hardware security modules (HSM) and multi-signature technologies. Kyneto has secured a total of USD 360M in cold storage insurance against physical damage or destruction, and third-party theft.</p>
